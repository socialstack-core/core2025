	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("region_create");
				Roles.Public.Grant("region_create");
				Roles.Guest.Grant("region_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("region_load", "region_list");
				Roles.Public.Revoke("region_load", "region_list");
				Roles.Member.Revoke("region_load", "region_list");
				*/
