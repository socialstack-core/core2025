	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("searchEntity_create");
				Roles.Public.Grant("searchEntity_create");
				Roles.Guest.Grant("searchEntity_create");
				*/
				
				//Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("searchEntity_load", "searchEntity_list");
				Roles.Public.Revoke("searchEntity_load", "searchEntity_list");
				Roles.Member.Revoke("searchEntity_load", "searchEntity_list");
