...
namespace Api.TypeScript.Objects
{
    ...
    public class ESModule : AbstractTypeScriptObject
    {
        ...
        /// <summary>
        /// Adds an explicitly constructed enum wrapper.
        /// </summary>
        public void AddEnum(ESEnum enumType) => _enums.Add(enumType);
        ...
        /// <summary>
        /// Adds a virtual field import (typically generated by virtual accessors).
        /// </summary>
        public void AddVirtualFieldImport(Type type) => _virtualFieldImportSymbols.Add(type);
        ...
        public override void ToSource(StringBuilder builder, TypeScriptService svc)
        {
            ...
            _types.ForEach(t => {
                ...
                t.ImportMissingTypes(svc.modules);
            });
