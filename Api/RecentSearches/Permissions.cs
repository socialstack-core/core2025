	...
	public class Permissions
	{
		...
		public Permissions()
		{
			...
			Events.CapabilityOnSetup.AddEventListener((Context context, object source) =>
			{
				...
				Roles.Member.Grant("recentSearch_create");
				Roles.Public.Grant("recentSearch_create");
				Roles.Guest.Grant("recentSearch_create");
				
				// Remove public viewing (as it's enabled by default):
				Roles.Guest.Revoke("recentSearch_load", "recentSearch_list");
				Roles.Public.Revoke("recentSearch_load", "recentSearch_list");
				Roles.Member.Revoke("recentSearch_load", "recentSearch_list");
				*/
