		...
		>
			<div className="mb-3">
				...
				{!cartIsEmpty() && <>
					...
					{
						//This is only to show with anonymous users
						role.id == 6 ?
						<Input type='checkbox' name='carehomeConfirmation' label='I confirm I am making this purchase on behalf of a registered carehome' validate={['Required']} /> :
						null
					}
