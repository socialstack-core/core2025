...
const Search: React.FC<SearchProps> = ({ searchPlaceholder, ...props }) => {
	...
	return (
		<div className="site-nav__search">
			<Button outlined className="site-nav__search-trigger" popoverTarget="search_popover">
				{/*
			...
			<Popover className="site-nav__search-wrapper" method="auto" id="search_popover" alignment="top" underHeader tabletLandscapeVisible backgroundActive={true}>
