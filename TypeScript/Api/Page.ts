...
export class PageApi extends AutoController<Page,uint>{
     ...
     * @url 'v1/page/tree'
     */
    getRouterTreeNode = (location: RouterTreeLocation): Promise<TreeNodeDetail | undefined> => {
     ...
     * @url 'v1/page/tree'
     */
    getRouterTreeNodePath = (url: string): Promise<TreeNodeDetail | undefined> => {
        return getJson<TreeNodeDetail | undefined>(this.apiUrl + '/tree?url=' + url + '')
    }
     ...
     * @url 'v1/page/state'
     */
    pageState = (pageDetails: PageDetails): Promise<void> => {
        return getJson<void>(this.apiUrl + '/state', pageDetails)
    }
