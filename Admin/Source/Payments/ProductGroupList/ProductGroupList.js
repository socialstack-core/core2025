...
export default function ProductGroupList(props) {
	...
	*/
	...
	return (
		<div className="admin-payments-product-group-list">
			{/*<Container>
				<Row>
					<Col size={12}>
					</Col>
...
ProductGroupList.propTypes = {
	...
	// Also the special id type which can be used to select some other piece of content (by productGroupList name), like this:
...
ProductGroupList.icon='align-center'; // fontawesome icon
*/